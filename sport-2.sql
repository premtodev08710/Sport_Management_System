...
(1, 9, 1, '2022-11-07', '2022-11-07', 1, 1),
(2, 9, 1, '2022-10-04', '2022-11-01', 8, 1),
(11, 9, 1, '2022-11-07', '2022-11-07', 1, 1),
(13, 0, 1, '2022-11-01', '2022-11-08', 2, 1),
(14, 0, 1, '2022-11-08', '2022-11-08', 1, 0);
...
INSERT INTO `receipt` (`id`, `borrow_id`, `date`, `price`) VALUES
(6, 13, 7, 140);
...
INSERT INTO `sports_equipment` (`sport_id`, `sport_name`, `typesport_id`, `balance`, `number`, `status_sport`) VALUES
(1, 'บอลเล่', 4, 9, 10, 1),
(2, 'บอลเล่vv', 4, 0, 10, 0);
...
(1, 0, 'aaa@g', 'c6f057b86584942e415435ffb1fa93d4', 'aa111', 'aa', 'A'),
