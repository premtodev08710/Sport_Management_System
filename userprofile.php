                    ...
                    ?>
                            <div class="col-sm-12 col-xl-12">
                                <div class="bg-light rounded h-100 p-4">
                                    <h6 class="mb-4">แก้ไขข้อมูลส่วนตัว</h6>

                                    <div class="form-floating mb-3">
                                        <input type="text" name="Firstname" value="<?php echo $row["Firstname"]; ?>" class="form-control" id="floatingInput" placeholder="name@example.com">
                                        <label for="floatingInput">ชื่อ</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" name="Lastname" value="<?php echo $row["Lastname"]; ?>" class="form-control" id="floatingInput" placeholder="name@example.com">
                                        <label for="floatingInput">นามสกุล</label>
                                    </div>
                                
                                    <div class="form-floating mb-3">
                                        <input type="text" name="Username" value="<?php echo $row["Username"]; ?>" class="form-control" id="floatingInput" placeholder="name@example.com">
